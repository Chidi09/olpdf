      ...
      <div className="relative flex min-h-screen w-full flex-col border-r border-[#222] px-8 py-10 lg:w-[40%]">
        ...
        <div className="mx-auto flex w-full max-w-sm flex-1 flex-col justify-center">
            ...
            {(["password", "magic"] as const).map((m) => (
              <button
                ...
                className={`flex-1 rounded-md py-1.5 text-xs font-semibold transition-all ${
                  mode === m ? "bg-white/10 text-white shadow-sm" : "text-white/40 hover:text-white/70"
                }`}
              >
            ...
            <form onSubmit={onSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="h-9 w-full rounded-lg border border-white/10 bg-white/5 px-3 text-sm text-white placeholder-white/30 backdrop-blur-sm transition-all focus:border-orange-500/60 focus:outline-none focus:ring-1 focus:ring-orange-500/20"
                  required
                />
              </div>
              <div>
          ...
          <div className="space-y-3">
            <button onClick={signInWithGoogle} className="flex h-9 w-full items-center justify-center gap-2 rounded-lg liquid-glass liquid-glass-noise text-sm font-medium text-white/80 transition-all hover:text-white active:scale-[0.98]">
            ...
            <button onClick={signInWithGitHub} className="flex h-9 w-full items-center justify-center gap-2 rounded-lg liquid-glass liquid-glass-noise text-sm font-medium text-white/80 transition-all hover:text-white active:scale-[0.98]">
