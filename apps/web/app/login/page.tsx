          ...
          <div className="space-y-5">
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5">
                <label className="block text-sm font-bold text-[var(--text-primary)] font-sans">
                  Password
                </label>
                <Link href="/forgot-password" title="forgot-password" className="text-sm font-bold text-orange-500 hover:text-orange-600 transition-colors">
                  Forgot?
                </Link>
              </div>
              <input
