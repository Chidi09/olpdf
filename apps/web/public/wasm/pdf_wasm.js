...
export class PdfDocument {
    ...
    constructor(data) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.pdfdocument_load(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0];
        PdfDocumentFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * @returns {number}
...
export class WasmCertificate {
    ...
    static load(data) {
        const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmcertificate_load(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return WasmCertificate.__wrap(ret[0]);
    }
    /**
    ...
    static loadPem(cert_pem, key_pem) {
        ...
        const ret = wasm.wasmcertificate_loadPem(ptr0, len0, ptr1, len1);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return WasmCertificate.__wrap(ret[0]);
    ...
    static loadPkcs12(data, password) {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.wasmcertificate_loadPkcs12(ptr0, len0, ptr1, len1);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return WasmCertificate.__wrap(ret[0]);
...
export class WasmDocumentBuilder {
    ...
    a4Page() {
        ...
        return WasmFluentPageBuilder.__wrap(ret[0]);
    }
    /**
     * Set document author.
     * @param {string} author
    ...
    roleMap(custom, standard) {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.wasmdocumentbuilder_roleMap(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    ...
    toBytesEncrypted(user_password, owner_password) {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.wasmdocumentbuilder_toBytesEncrypted(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
...
export class WasmEmbeddedFont {
    ...
    static fromBytes(data, name) {
        ...
        const ret = wasm.wasmembeddedfont_fromBytes(ptr0, len0, ptr1, len1);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return WasmEmbeddedFont.__wrap(ret[0]);
    }
    /**
...
export class WasmFluentPageBuilder {
    ...
    comboBox(name, x, y, w, h, options, selected) {
        ...
        const len1 = WASM_VECTOR_LEN;
        var ptr2 = isLikeNone(selected) ? 0 : passStringToWasm0(selected, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len2 = WASM_VECTOR_LEN;
        const ret = wasm.wasmfluentpagebuilder_comboBox(this.__wbg_ptr, ptr0, len0, x, y, w, h, ptr1, len1, ptr2, len2);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    ...
    footnote(ref_mark, note_text) {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.wasmfluentpagebuilder_footnote(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    ...
    imageWithAlt(bytes, x, y, w, h, alt_text) {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.wasmfluentpagebuilder_imageWithAlt(this.__wbg_ptr, ptr0, len0, x, y, w, h, ptr1, len1);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    ...
    pushButton(name, x, y, w, h, caption) {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.wasmfluentpagebuilder_pushButton(this.__wbg_ptr, ptr0, len0, x, y, w, h, ptr1, len1);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    ...
    radioGroup(name, values, xs, ys, ws, hs, selected) {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passArrayF32ToWasm0(xs, wasm.__wbindgen_malloc);
        const len2 = WASM_VECTOR_LEN;
        const ptr3 = passArrayF32ToWasm0(ys, wasm.__wbindgen_malloc);
        const len3 = WASM_VECTOR_LEN;
        const ptr4 = passArrayF32ToWasm0(ws, wasm.__wbindgen_malloc);
        const len4 = WASM_VECTOR_LEN;
        const ptr5 = passArrayF32ToWasm0(hs, wasm.__wbindgen_malloc);
        const len5 = WASM_VECTOR_LEN;
        var ptr6 = isLikeNone(selected) ? 0 : passStringToWasm0(selected, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len6 = WASM_VECTOR_LEN;
        const ret = wasm.wasmfluentpagebuilder_radioGroup(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, ptr4, len4, ptr5, len5, ptr6, len6);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    ...
    streamingTable(spec) {
        ...
        return StreamingTable.__wrap(ret[0]);
    }
    /**
     * @param {number} r
     * @param {number} g
    ...
    textField(name, x, y, w, h, default_value) {
        ...
        var len1 = WASM_VECTOR_LEN;
        const ret = wasm.wasmfluentpagebuilder_textField(this.__wbg_ptr, ptr0, len0, x, y, w, h, ptr1, len1);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
...
export class WasmOcrEngine {
    ...
    constructor(_det_model_path, _rec_model_path, _dict_path, _config) {
        const ptr0 = passStringToWasm0(_det_model_path, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(_rec_model_path, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(_dict_path, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        let ptr3 = 0;
...
export class WasmPdf {
    ...
    static fromBytes(data) {
        const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmpdf_fromBytes(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return WasmPdf.__wrap(ret[0]);
    }
    /**
    ...
    static fromHtml(content, title, author) {
        ...
        var len2 = WASM_VECTOR_LEN;
        const ret = wasm.wasmpdf_fromHtml(ptr0, len0, ptr1, len1, ptr2, len2);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return WasmPdf.__wrap(ret[0]);
    ...
    static fromHtmlCss(html, css, font_bytes) {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passArray8ToWasm0(font_bytes, wasm.__wbindgen_malloc);
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.wasmpdf_fromHtmlCss(ptr0, len0, ptr1, len1, ptr2, len2);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return WasmPdf.__wrap(ret[0]);
    ...
    static fromHtmlCssWithFonts(html, css, families, fonts) {
        ...
        const ptr1 = passStringToWasm0(css, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passArrayJsValueToWasm0(families, wasm.__wbindgen_malloc);
        const len2 = WASM_VECTOR_LEN;
        const ptr3 = passArrayJsValueToWasm0(fonts, wasm.__wbindgen_malloc);
        const len3 = WASM_VECTOR_LEN;
        const ret = wasm.wasmpdf_fromHtmlCssWithFonts(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return WasmPdf.__wrap(ret[0]);
    ...
    static fromImageBytes(data) {
        const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmpdf_fromImageBytes(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return WasmPdf.__wrap(ret[0]);
    ...
    static fromMarkdown(content, title, author) {
        ...
        var ptr2 = isLikeNone(author) ? 0 : passStringToWasm0(author, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len2 = WASM_VECTOR_LEN;
        const ret = wasm.wasmpdf_fromMarkdown(ptr0, len0, ptr1, len1, ptr2, len2);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return WasmPdf.__wrap(ret[0]);
    ...
    static fromMultipleImageBytes(images_array) {
        const ret = wasm.wasmpdf_fromMultipleImageBytes(images_array);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return WasmPdf.__wrap(ret[0]);
    ...
    static fromText(content, title, author) {
        ...
        var ptr2 = isLikeNone(author) ? 0 : passStringToWasm0(author, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len2 = WASM_VECTOR_LEN;
        const ret = wasm.wasmpdf_fromText(ptr0, len0, ptr1, len1, ptr2, len2);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return WasmPdf.__wrap(ret[0]);
    ...
    static merge(pdfs) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmpdf_merge(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return WasmPdf.__wrap(ret[0]);
...
export class WasmPdfDocument {
    ...
    embedFile(name, data) {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.wasmpdfdocument_embedFile(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    ...
    extractSpans(page_index, region, reading_order) {
        ...
        var len1 = WASM_VECTOR_LEN;
        const ret = wasm.wasmpdfdocument_extractSpans(this.__wbg_ptr, page_index, ptr0, len0, ptr1, len1);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    constructor(data, password) {
        ...
        var len1 = WASM_VECTOR_LEN;
        const ret = wasm.wasmpdfdocument_new(ptr0, len0, ptr1, len1);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0];
    ...
    static openFromDocxBytes(data) {
        const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmpdfdocument_openFromDocxBytes(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return WasmPdfDocument.__wrap(ret[0]);
    }
    /**
    ...
    static openFromPptxBytes(data) {
        const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmpdfdocument_openFromPptxBytes(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return WasmPdfDocument.__wrap(ret[0]);
    ...
    static openFromXlsxBytes(data) {
        const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmpdfdocument_openFromXlsxBytes(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return WasmPdfDocument.__wrap(ret[0]);
    ...
    within(page_index, region) {
        ...
        return WasmPdfPageRegion.__wrap(ret[0]);
    }
    /**
...
export class WasmTimestamp {
    ...
    static parse(data) {
        const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmtimestamp_parse(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return WasmTimestamp.__wrap(ret[0]);
    }
    /**
 ...
 * @returns {any}
 */
export function preflight_pdf(data) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.preflight_pdf(ptr0, len0);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function preflight_streaming(data) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.preflight_streaming(ptr0, len0);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
export function signPdfBytes(pdf_data, cert, reason, location) {
    ...
    var len2 = WASM_VECTOR_LEN;
    const ret = wasm.signPdfBytes(ptr0, len0, cert.__wbg_ptr, ptr1, len1, ptr2, len2);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
