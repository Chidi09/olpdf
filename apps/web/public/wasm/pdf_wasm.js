...
export class PdfDocument {
     ...
     */
    add_object(value) {
        const ret = wasm.pdfdocument_add_object(this.__wbg_ptr, value);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ret[0] >>> 0;
     ...
     * @returns {any}
     */
    get_form_field_layout_objects(page_num) {
        const ret = wasm.pdfdocument_get_form_field_layout_objects(this.__wbg_ptr, page_num);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @param {number} gen_num
     * @returns {any}
     */
    get_object(obj_num, gen_num) {
        const ret = wasm.pdfdocument_get_object(this.__wbg_ptr, obj_num, gen_num);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @param {any} value
     */
    set_object(obj_num, gen_num, value) {
        const ret = wasm.pdfdocument_set_object(this.__wbg_ptr, obj_num, gen_num, value);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
